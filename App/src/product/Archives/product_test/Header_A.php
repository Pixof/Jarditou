            ...
            <div class="container-fluid " >
                    <header>
                        <div class="row align-items-center">
                            <div id="block1" class=" col-lg-8 bg-white d-none d-lg-block "><img src="/DW 2021/Jarditou Boot PHP/src/img/jarditou_logo.jpg" style="width:25%; height:auto; padding: 5px;"  alt="Photo" ></div>
                    ...
                    <!-- Espace : promotion -->
                    <div class="row">
                        <img class="img-fluid col-12 shadow mb-1 bg-white" src="/DW 2021/Jarditou Boot PHP/src/img/promotion.jpg" alt="responsive photo promo" >
                    </div>
