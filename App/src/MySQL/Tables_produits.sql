...
CREATE TABLE IF NOT EXISTS `produits` (
  ...
  `pro_d_modif` date DEFAULT NULL COMMENT 'Date de modification',
...
INSERT INTO `produits` (`pro_id`, `pro_cat_id`, `pro_ref`, `pro_libelle`, `pro_description`, `pro_prix`, `pro_stock`) VALUES
(7, 27, 'barb001', 'Aramis ', 'Lorem ipsum dolor sit amet. ', '110.00', 2),
